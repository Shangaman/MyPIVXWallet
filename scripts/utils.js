 ...
 */
export function debugEval(func, ...args) {
    if (debug) {
        func(...args);
    }
}
 ...
 * @param {string} topic - topic of the debug
 * @param args - arguments to print
 */
export function debugLog(topic, ...args) {
    debugEval(console.log, topic, ...args);
}
 ...
 */
export function debugTimerStart(label) {
    debugEval(console.time, label);
}

/**
 * End a timer if we are in debug
 * @param label - the label of the timer
 */
export function debugTimerEnd(label) {
    debugEval(console.timeEnd, label);
}
